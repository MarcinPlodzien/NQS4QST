...
CONFIG = {
    ...
    "log_every": 15,   # Record loss/fidelity every log_every epochs
...
cfg4["shots_per_basis"] = 5000 # shots per basis
cfg4["shots"] = cfg4["shots_per_basis"] # IMPORTANT: shots and shots_per_basis must be equal   
