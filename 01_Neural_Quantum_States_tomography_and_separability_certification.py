...
This "random basis pool" approach keeps the flavor of random local
measurements while ensuring the number of bases in the NLL remains
controlled (B = num_random_bases or less).
